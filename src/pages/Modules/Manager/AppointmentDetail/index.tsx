...
const FutureAppointmentDetail: React.FC = () => {
  ...
  const appointmentCanceled = useMemo(() => {
    return {
      data: 'Reserva cancelada com sucesso!',
      textColor: '#231f20',
  ...
  }, [id_appointment, generalErrorToastOpts]);
  ...
  const handleCancelAppointment = useCallback(() => {
    ...
    api
      ...
      .then(response2 => {
        WToast.show(appointmentCanceled);
        setLoading(false);
        onGoBack();
        navigation.goBack();
      });
  }, [id_appointment, appointmentCanceled, navigation]);
              ...
              <Content>
                ...
                {materials.length === 0 ? (
                  ...
                  <>
                    ...
                    <MaterialsContainer>
                      <MaterialsTitle>Materiais: </MaterialsTitle>
                      <MaterialsList
                        data={materials}
                ...
                <OptionsContainer>
                  <CancelAppointmentButton onPress={() => confirmCancel()}>
                  ...
                  >
                    ...
                    <EditAppointmentText>Editar Horário</EditAppointmentText>
                  </EditAppointmentButton>
                </OptionsContainer>
              </Content>
            )}
