...
const SelectDayHour: React.FC = () => {
  ...
  const cancelSucessToastOpts = useMemo(() => {
    return {
      data: 'Reservas canceladas com sucesso!',
      textColor: '#231f20',
  ...
  const [
    ...
    setShowCreateAppointmentButton,
  ] = useState(false);
  ...
  }, [selectedDate, selectedCourt, generalErrorToastOpts]);
  ...
  }, [selectedCourt, generalErrorToastOpts, selectedDate]);
                  ...
                  .then(() => {
                    api
                      ...
                      .then(response => {
                        setAvailability(response.data);
                        disableMultiSelection();
                        WToast.show(cancelSucessToastOpts);
                        setLoading(false);
                      })
                      .catch(error => {
                        WToast.show(generalErrorToastOpts);
